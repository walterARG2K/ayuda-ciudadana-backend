export function templateSendCode({ code, email }) {
...
<tbody><tr>
<td style="padding:0;Margin:0;font-size:0px" align="center"><p class="adapt-img" src="https://vqrktb.stripocdn.email/content/guids/CABINET_3826098ebb16d988b9410e0a310c23e9/images/lucas_joseph.png" alt="Logo" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;font-size: 21px;" title="Logo" height="34">AYUDA CIUDADANA</p></td>
</tr>
<tr>
...
<table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
<tbody><tr>
<td align="center" style="padding:0;Margin:0;padding-top:15px"><h3 style="Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333">Nuestras Redes<br></h3></td>
</tr>
</tbody></table></td>
</tr>
</tbody></table><!--[if mso]></td><td style="width:20px"></td><td style="width:320px" valign="top"><![endif]-->
